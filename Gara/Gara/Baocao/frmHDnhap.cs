...
namespace SamLop.Baocao
{
    public partial class frmHDnhap : Form
    {
        ...
        {
            gridControl1.DataSource = ChiTietNhapService.Chitiethoadonnhap_GetByAll();
        ...
        private void buttonX6_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                connection1.Open();
                SqlCommand cmd = new SqlCommand("select * from Chitiethoadonnhap where ngaynhap >='" + datetu + "' and ngaynhap <='" + dateden + "'", connection1);
        ...
        private void butint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connection1 = new SqlConnection(connectionstring);
                connection1.Open();
                SqlCommand cmd = new SqlCommand("select * from Chitiethoadonnhap where NgayNhap >='" + datetu + "' and NgayNhap <=N'" + dateden + "'", connection1);
                var da = new SqlDataAdapter(cmd);
